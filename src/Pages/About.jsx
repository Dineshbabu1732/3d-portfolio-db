  ...
  return (
    <section className="max-container">
      <h1 className="head-text">
        Hello, I'm{" "}
        <span className="text-red-600 font-semibold drop-shadow">
          Dinesh Babu
        </span>
      </h1>
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
           I've worked with all sorts of companies, leveling up my skills and teaming up with smart people, Here's the roundown:
          </p>
        </div>
        ...
        <VerticalTimeline>
          {experiences.map((experience) => (
            ...
            date={experience.date} icon={<div className='flex justify-center items-center w-full h-full'>
